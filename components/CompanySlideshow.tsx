...
const CompanySlideshow = () => {
  ...
  return (
    <section id="company-slideshow" className="section-padding bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-purple-400/10 to-pink-400/10 rounded-full blur-3xl animate-float-delayed"></div>
      </div>
      ...
      <div className="container-custom relative z-10">
          ...
          <div className="relative">
            ...
            <div className="glass-effect rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
              ...
              <div className="mb-6">
                ...
                <div className="inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-4 py-2 rounded-full text-sm font-medium">
                  {companies[currentIndex].industry}
                </div>
              </div>

              {/* Quote */}
              <blockquote className="text-lg md:text-xl text-gray-600 dark:text-gray-300 italic mb-8">
        ...
        {/* Stats Section */}
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto mt-16 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {[
