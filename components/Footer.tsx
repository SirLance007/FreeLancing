      ...
      <div className="container-custom py-16">
        <div className="grid lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-blue-600 dark:text-blue-400">Small Accounting Solutions</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Professional Tax & Accounting</p>
              </div>
            </div>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Tools</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Corporate</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 py-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-lg font-semibold mb-6 text-blue-600 dark:text-blue-400">Contact Information</h4>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm">+91 9664069669</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm">smallaccountingsolution@yahoo.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <Clock className="w-5 h-5 text-blue-600 dark:text-blue-400 flex-shrink-0" />
                  <div>
                    <span className="text-gray-900 dark:text-white font-medium">Business Hours:</span>
                    <p className="text-gray-600 dark:text-gray-300 text-sm">Mon - Fri: 9:00 AM - 6:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4 text-blue-600 dark:text-blue-400">About Small Accounting Solutions</h4>
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-600 dark:text-gray-300 text-sm">Authorized e-filing intermediary</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Globe className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                  <span className="text-gray-600 dark:text-gray-300 text-sm">Registered tax consultant</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Globe className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                  <span className="text-gray-600 dark:text-gray-300 text-sm">ISO certified processes</span>
                </div>
              </div>
            </div>
          </div>
